...
```
var arr = [1.1,2.2]
                                                                               Pointer Compression OFF         Pointer Compression ON ([v8 Version ] > 8) 
            `````````````````````````````````
            `  Map [PACKED_DOUBLE_ELEMENTS] ` <-+                                      8 bytes                              r13 + 4 bytes
            `````````````````````````````````   |
            `    Length   [2]               `   |                                      4 bytes                              r13 + 4 bytes << 1
            `````````````````````````````````   |     
            `     1.1                       `   |                                      8 bytes                                 8 bytes
            `````````````````````````````````   |
            `     2.2                       `   |                                      8 bytes                                 8 bytes
            `````````````````````````````````   |
			      ` Map(PACKED_DOUBLE_ELEMENTS)   `   |  <---  Start                         8 bytes                              r13 + 4 bytes
            `````````````````````````````````   |             
			      `  Properties <FixedArray[0]>   `   |                                      8 bytes                              r13 + 4 bytes
			      `````````````````````````````````   |
            ` Elements <FixedDoubleArray[1]>` --+                                      8 bytes                              r13 + 4 bytes
			      `````````````````````````````````
			      `   Length [2]                  `                                          8 bytes                              r13 + 4 bytes << 1
            `````````````````````````````````
